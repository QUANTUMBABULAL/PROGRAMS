...
This is the easy version of the problem. The difference between the versions is that in this version, the constraint on n
 is lower. You can hack only if you solved all versions of this problem.
